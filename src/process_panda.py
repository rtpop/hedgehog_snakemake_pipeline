...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Process panda network.")

    # Parse args for the main function
    parser.add_argument('input_file', type=str, help='Path to panda file.')
...
def main():
    ...
    eland.process_edge_list(updated_panda_file, args.output_file, sep = args.delimiter)
